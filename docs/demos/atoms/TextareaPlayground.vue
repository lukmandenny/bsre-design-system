...
// Sesuaikan path ini dengan lokasi BaseTextarea kamu

// --- STATE ---
const textValue = ref('');
const label = ref('Catatan Tambahan');
const placeholder = ref('Ketik catatan Anda di sini...');
const rows = ref(3);
const hint = ref('Catatan ini akan dilampirkan pada laporan akhir.');
const errorMessage = ref('Catatan tidak boleh kosong!');
...
const codeSnippet = computed(() => {
  ...
  return `<template>
  <BaseTextarea${propsString}/>
</template>

<script setup>
import { ref } from 'vue';
const textValue = ref('${textValue.value}');
<\/script>`;
});
      ...
      <div class="space-y-6">
        ...
        <div class="flex gap-6">
          ...
          <div class="flex-1">
            ...
            >
            <label
              class="flex items-center w-fit gap-3 cursor-pointer select-none bg-white border border-gray-200 py-3 px-4 rounded-xl hover:border-gray-300 shadow-sm transition-colors"
            >
              <div
